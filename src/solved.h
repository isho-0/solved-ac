...
// 첫째 줄에는 별 N개, 둘째 줄에는 별 N-1개, ..., N번째 줄에는 별 1개를 찍는
// 문제
// @param N 정수 (1 <= N <= 100)
...
// 2442번 별 찍기-5 문제 해결 함수
// 첫째 줄에는 별 1개, 둘째 줄에는 별 3개, ..., N번째 줄에는 별 2×N-1개를 찍는
// 문제(별은 가운데 기준 대칭) param N 정수 (1 <= N <= 100)
void print_stars_5(int n);

// 2443번 별 찍기-6 문제 해결 함수
// 첫째 줄에는 별 2×N-1개, 둘째 줄에는 별 2×N-3개, ..., N번째 줄에는 별 1개를
// 찍는 문제 문제(별은 가운데 기준 대칭) param N 정수 (1 <= N <= 100)
void print_stars_6(int n);
